...
test_digest_create_ok()
{
	...
	digest_str = strdup("Digest realm=\"test\", qop=\"auth-int,auth\", nonce=\"9e9cb182c25b68148676a98cda86d501\" opaque=\"9bc51272c609b6b6bb3547fac2102e78\"");

	d = digest_create(digest_str);
	mu_assert("should be able to create a new digest object", NULL != d);
